...
public class StreamEnvelopeDocumentTest extends AbstractEnvelopeTest {
    ...
    public void testCreateStreamBasedEnvelopeDocumentWithoutInputStream_ThrowsNullPointerException() throws Exception {
        ...
        new StreamEnvelopeDocument(null, MIME_TYPE_APPLICATION_TXT, TEST_FILE_NAME_TEST_TXT);
    }
    ...
    public void testCreateStreamBasedEnvelopeDocumentWithoutMimeType_ThrowsNullPointerException() throws Exception {
        ...
        new StreamEnvelopeDocument(new ByteArrayInputStream(TEST_DATA_TXT_CONTENT), null, TEST_FILE_NAME_TEST_TXT);
    }
    ...
    public void testCreateStreamBasedEnvelopeDocumentWithoutFileName_ThrowsNullPointerException() throws Exception {
        ...
        new StreamEnvelopeDocument(new ByteArrayInputStream(TEST_DATA_TXT_CONTENT), MIME_TYPE_APPLICATION_TXT, null);
    }
