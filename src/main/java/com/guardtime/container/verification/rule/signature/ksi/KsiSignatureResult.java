...
public  class KsiSignatureResult implements SignatureResult<KSISignature, VerificationResult> {
    ...
    public KsiSignatureResult(VerificationResult result, com.guardtime.container.verification.result.VerificationResult simpleResult, KSISignature signature) {
        this.result = result;
