...
/**
 * Wrapper for a {@link Document} which creates a backward link to the {@link SignatureContent} the contains the Document and
 * that provides the {@link EnvelopeSignature} for the document.
 * Helper class to allow for simpler association between a {@link Document} and {@link EnvelopeSignature} and any related
 * {@link Annotation}s.
 */
