...
public class ResultHolder {
    ...
    private final List<RuleVerificationResult> envelopeResults;
    ...
    public ResultHolder() {
        this.envelopeResults = new ArrayList<>();
    ...
    public List<RuleVerificationResult> getResults() {
        ...
        allResults.addAll(envelopeResults);
    ...
    public List<RuleVerificationResult> getResults(SignatureContent content) {
        ...
        ruleVerificationResults.addAll(envelopeResults); // Lets make sure that generic envelope rules are accessible as well
